        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-12 mb-12 md:mb-20">
          ...
          >
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-4 md:px-6 lg:px-9 py-6 md:py-3 rounded-xl md:rounded-2xl shadow-xl text-center min-w-40 md:min-w-48 lg:min-w-64 mx-auto"
              >
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-4 md:p-6"
              >
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-3xl p-4 md:p-6 text-white"
              >
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-3xl p-4 md:p-6 lg:p-8 text-white relative overflow-hidden"
            >
              <FaQuoteLeft className="absolute top-6 right-6 text-white/20 text-4xl md:text-6xl" />
            ...
            <div className="space-y-6">
              ...
              >
                {principles.map((principle, index) => (
                  <motion.div
                    ...
                    className="bg-white rounded-2xl p-3 md:p-4 shadow-lg border border-gray-100 text-center"
                  >
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.6 }}
                className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-4 md:p-6 text-white"
              >
                <h4 className="text-lg md:text-xl font-bold mb-3 flex items-center gap-2">
                  <FaGraduationCap />
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.8 }}
                className="bg-gradient-to-r from-gray-800 to-blue-700 rounded-2xl p-4 md:p-6 text-white"
              >
                <h4 className="text-lg md:text-xl font-bold mb-3 flex items-center gap-2">
