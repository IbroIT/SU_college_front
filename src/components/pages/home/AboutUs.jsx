...
const AboutUs = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-white">
      {/* Header Section */}
      <div className="relative bg-gradient-to-r from-blue-900 to-blue-800 py-12 md:py-20">
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          <h1 className={`text-3xl md:text-5xl font-bold text-white mb-6 transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            {t('about.title')}
          </h1>
          <div className="w-24 h-1 bg-blue-400 mx-auto mb-8"></div>
          <p className={`text-xl md:text-lg text-blue-100 max-w-4xl mx-auto leading-relaxed mb-6 transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            {t('about.subtitle')}
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
          ...
          <div className={`transition-all duration-1000 delay-700 ${
            ...
            <div className="relative">
              <img 
                ...
                className="w-full h-64 md:h-80 lg:h-[500px] object-cover rounded-lg shadow-2xl"
              />
              <div className="absolute -bottom-3 md:-bottom-6 -right-3 md:-right-6 w-20 h-20 md:w-32 md:h-32 bg-blue-600 rounded-lg shadow-2xl flex items-center justify-center">
                <PartnershipIcon className="w-10 h-10 md:w-16 md:h-16 text-white" />
              </div>
            </div>
          </div>
        ...
        {/* Features Section */}
        <div className={`mb-12 md:mb-20 transition-all duration-1000 delay-1100 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
