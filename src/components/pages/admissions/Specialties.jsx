    ...
    <div className="specialties-page min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg text-center transform hover:scale-105 transition-all duration-300 border border-white/20">
            ...
            <div className="text-gray-600 font-medium">Направления</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg text-center transform hover:scale-105 transition-all duration-300 border border-white/20">
            ...
            <div className="text-3xl font-bold text-gray-800 mb-2">290+</div>
            <div className="text-gray-600 font-medium">Студентов</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg text-center transform hover:scale-105 transition-all duration-300 border border-white/20">
            ...
            <div className="text-gray-600 font-medium">Трудоустройство</div>
          </div>
        </div>
